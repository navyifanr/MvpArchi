...
--------------------------------------
## 前言
没有规矩不成方圆，但规则是人制定的，没有标准，只有适合自己或团队的才是最好的，当然前提是整体上要符合编程语言的规范。以下规范是我之前在公司编写的规范文档。(参考修改自[【Android开发规范】-gityuan](http://gityuan.com/2015/08/10/android-arch-coding-style/))
